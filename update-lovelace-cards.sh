...
FER_TAG=$(curl -s https://api.github.com/repos/$FER_REPO/releases/latest | jq -r '.tag_name')
...
LC_TAG=$(curl -s https://api.github.com/repos/$LC_REPO/releases/latest | jq -r '.tag_name')
...
MP_TAG=$(curl -s https://api.github.com/repos/$MP_REPO/releases/latest | jq -r '.tag_name')
...
MER_TAG=$(curl -s https://api.github.com/repos/$MER_REPO/releases/latest | jq -r '.tag_name')
...
SIC_TAG=$(curl -s https://api.github.com/repos/$SIC_REPO/releases/latest | jq -r '.tag_name')
...
TER_TAG=$(curl -s https://api.github.com/repos/$TER_REPO/releases/latest | jq -r '.tag_name')
